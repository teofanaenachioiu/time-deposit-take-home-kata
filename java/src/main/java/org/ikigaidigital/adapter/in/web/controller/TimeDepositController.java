package org.ikigaidigital.adapter.in.web.controller;
...
public class TimeDepositController {
	...
	@Operation(summary = "Get all time deposits", description = "Returns all time deposits together with their withdrawals.")
	@ApiResponses(value = {
			@ApiResponse(responseCode = "200", description = "Time deposits retrieved successfully", content = @Content(array = @ArraySchema(schema = @Schema(implementation = TimeDepositResponseDTO.class)))),
	...
	@Operation(summary = "Update balances for all time deposits", description = "Calculates and updates the balance for all time deposits.")
	@ApiResponses(value = {
			@ApiResponse(responseCode = "204", description = "Balances updated successfully", content = @Content),
			@ApiResponse(responseCode = "500", description = "Unexpected server error", content = @Content)})
